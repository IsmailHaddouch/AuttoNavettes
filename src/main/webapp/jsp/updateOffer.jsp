    ...
    <div class="container">
        ...
        <c:if test="${not empty offer}">
            <form action="${pageContext.request.contextPath}/updateOffer" method="post">
                ...
                <input type="time" name="departureTime" id="departureTime" value="${offer.departureTime}" required />
                
                <label for="arrivalTime">Arrival Time:</label>
                <input type="time" name="arrivalTime" id="arrivalTime" value="${offer.arrivalTime}" required />
                ...
                <input type="submit" value="Update Offer" id="submit" />
            </form>
        </c:if>
        <p>
